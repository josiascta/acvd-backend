...
public class RequisicaoService {
    ...
    // Novos repositórios injetados para buscar os detalhes completos
    private final ContaBancariaRepository contaBancariaRepository;
    private final DocumentoRepository documentoRepository;
    private final ResponsavelLegalRepository responsavelLegalRepository;

    // ... (Mantenha os métodos adicionarDiscenteAViagem e adicionarDiscenteAViagemPorEmail iguais ao que já tínhamos) ...
    ...
    /**
     * AÇÃO DO DISCENTE: Enviar a requisição para análise (Muda o Status).
     */
    @Transactional
    public RequisicaoDTO.Response enviarParaAnalise(UUID discenteId, UUID requisicaoId) throws RegraDeNegocioException {
        ...
        // Garante que o aluno só mexe na requisição dele
        ...
        // Garante que a requisição está num estado válido para ser enviada
        ...
        // Validação: Verifica se o aluno já preencheu a conta bancária
        ...
        // Validação: Verifica se o aluno enviou o documento de identidade
        ...
        // Vincula a conta bancária à requisição e avança o status
        requisicao.setContaBancaria(conta);
        requisicao.setStatus(StatusRequisicao.AGUARDANDO_ANALISE);
        requisicao.setMotivoReprovacao(null); // Limpa qualquer motivo de reprovação antigo

        return new RequisicaoDTO.Response(requisicaoRepository.save(requisicao));
    }

    /**
     * AÇÃO DO SERVIDOR: Ver detalhes completos do aluno para poder avaliar.
     */
    ...
    public RequisicaoDetalhesDTO obterDetalhesParaAvaliacao(UUID servidorId, UUID requisicaoId) throws RegraDeNegocioException {
        ...
        // Segurança: Apenas o servidor responsável pela viagem pode ver os detalhes
        ...
        // Busca as informações complementares
    ...
    // ... (Mantenha os métodos avaliarRequisicao, listarRequisicoesDaViagem e listarMinhasRequisicoes iguais ao que já tínhamos) ...
